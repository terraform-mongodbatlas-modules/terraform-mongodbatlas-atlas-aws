module "atlas_aws" {
  ...
  privatelink_regional_mode = "auto" # "auto" enables regional mode when the module sees multiple distinct Atlas regions. Ensure you understand the tradeoffs before enabling.
