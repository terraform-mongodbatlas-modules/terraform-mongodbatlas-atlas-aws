...
The cluster module defines shared tooling in [`.github/sdlc.src.yaml`](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-atlas-aws/blob/v0.1.0/.github/sdlc.src.yaml). The `path-sync` tool copies files one-way from cluster to destination modules.
